...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const root: MetadataRoute.Sitemap = [
    ...
    { url: SITE_URL + "/plaza/issues", lastModified: now, changeFrequency: "weekly", priority: 0.85 },
    ...
    { url: SITE_URL + "/plaza/human", lastModified: now, changeFrequency: "weekly", priority: 0.85 },
    { url: SITE_URL + "/plaza/drift", lastModified: now, changeFrequency: "weekly", priority: 0.85 },
