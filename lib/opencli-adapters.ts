    ...
    commands: [
      {
        ...
        smoke: "policy_briefing_press.py --keyword 정부조직 --limit 5 --format json",
      },
    ],
    ...
    commands: [
      {
        ...
        smoke: "MOLEG_OC=*** law.search --query 정부조직법 --limit 3",
      },
      {
        name: "law.article",
        ...
        smoke: "MOLEG_OC=*** law.article --law-id ... --article-no 2",
      },
    ],
